...
public class BotPlayer implements Player {
    ...
    private final CliBot bot;
    private final long maxTimeBank;
    private final long timePerMove;
    private final int id;
    private long timeBank;

    public BotPlayer(int id, CliBot bot, long maxTimeBank, long timePerMove) {
        this.id = id;
        this.name = String.format("player%d", id + 1);
        this.bot = bot;
